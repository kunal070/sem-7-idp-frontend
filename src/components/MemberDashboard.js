                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-xl font-bold leading-8">Pending</div>
                                    ...
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-xl font-bold leading-8">ERDA20230001</div>
                                    ...
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-xl font-bold leading-8">ASS20230001</div>
                                    ...
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-xl font-bold leading-8">--</div>
